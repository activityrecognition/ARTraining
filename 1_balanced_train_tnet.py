...
training_file,val_file = generate_training_validation_dataset(fold_nr=1)
...
h5f = h5py.File(os.path.join(h5_dataset_root,'tf_folds/1/training.h5'))
X = h5f['X']
Y = h5f['Y']

v_h5f = h5py.File(os.path.join(h5_dataset_root,'tf_folds/1/validation.h5'))
v_X = v_h5f['X']
v_Y = v_h5f['Y']
